        ...
        <form onSubmit={handleSubmit(onSubmit)} className="mt-6 space-y-4">
          ...
          <div className="relative">
            ...
            <div className="flex flex-wrap  gap-2">
              {rules.map((rule, i) => (
                <p
                  key={i}
                  className=" border p-1 border-gray-200 rounded-xl text-xs mt-1 flex items-center gap-1"
                  style={{ color: rule.test(password) ? "green" : "gray-300" }}
                >
          ...
          <div className="flex gap-2 smText px-8">
            ...
            <p>
              ...
              <a
                href="#"
                className="text-[#B7BE64] font-medium hover:underline"
              >
                Terms & Conditions
              </a>{" "}
              of Flowpense
